...
class Login extends CI_Controller
{
    ...
    public function signupMe()
    {
        ...
        $this->form_validation->set_rules('email', 'Email', 'required|valid_email|max_length[128]|xss_clean|trim');
        $this->form_validation->set_rules('password', 'Password', 'required|max_length[32]|');
        $this->form_validation->set_rules('confirm_password', 'Confirm Password', 'trim|required|max_length[32]|matches[password]');
        $this->form_validation->set_rules('phone_number','Mobile Number','required|min_length[10]|xss_clean');
        ...
        else
        {
            ...
            $userInfo = array('email'=>$email, 'password'=>getHashedPassword($password), 'roleId'=>'3', 'name'=> $name,
