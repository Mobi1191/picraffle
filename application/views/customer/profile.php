<div class="content-wrapper">
	<section class="content-header">
      <h1>
        <i class="fa fa-tachometer" aria-hidden="true"></i> My Profile
        <small></small>
      </h1>
    </section>
                            ...
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fname" placeholder="Full Name" name="fname" value="<?php echo $userinfo[0]->name; ?>" maxlength="128">
                                        <input type="hidden" value="<?php echo $vendorId; ?>" name="userId" id="userId" />    
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" placeholder="Enter email" name="email" value="<?php echo $userinfo[0]->email; ?>" maxlength="128">
                                    </div>
                                </div>
                            </div>
